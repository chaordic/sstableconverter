...
/**
 * NOTICE: The only difference between this class and the original class was the addition
 * of the "openForBatch()" method with the CFMetaData attribute.
 *
...
public class SSTableReader extends SSTable implements Closeable
{
    ...
    /**
     * The original method was passing a null CFMetadata, this method only allows passing the CFMetadata attribute
     */
    public static SSTableReader openForBatch(Descriptor descriptor, Set<Component> components, IPartitioner partitioner, CFMetaData metadata) throws IOException
    {
        SSTableMetadata sstableMetadata = openMetadata(descriptor, components, partitioner);
        SSTableReader sstable = new SSTableReader(descriptor,
                                                  components,
